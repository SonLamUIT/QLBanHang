        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            if ((tbx_TenDoiTac.Text != "") && (tbx_Sdt.Text != "") && (tbx_DiaChi.Text != ""))
            {
                try
                {
                    ...
                    //Them vao bang BAOCAOCONGNO
                    obj_BCCN_DAO.runProcThemBCNN(0, 0, obj_DoiTac.MaLoaiDoiTac);
                    //Them vao bang CT_BAOCAOCONGNO
                    obj_CTBCCN_DAO.themCT_BCNN(obj_CTBCCN_DAO.layMaBCCNLast(), obj_DoiTac_DAO.layMaDoiTacLast(), 0, 0, 0);
